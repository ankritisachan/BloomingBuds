...
<div style="background-color: #FFC0CB;width: 1000px;height: 280px;margin-left:167px;margin-top: 55px;float: left">
<div style="background-color: white;width: 100%;height: 100px;float: left;">
<h1 style="text-align: center;font-family: Algerian">ADD NOTIFICATIONS</h1>
</div>
<%
...
%>
<div>
<form method="post" action="/bloomingBuds/Notif">
<table>
<tr><td><br></td></tr>
<tr><td>Notification</td>
<td><textarea rows="7" cols="100" name="notif"></textarea></td>
</tr>
