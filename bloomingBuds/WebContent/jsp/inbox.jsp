...
<h1 style="text-align: center;font-family: Algerian">INBOX</h1>
</div>
<%
ResultSet rs = null;
...
String strsql="select subject,date,senderid,msgid from message where receiverid=? and receiverstatus=?";
...
<form method="post" action="/bloomingBuds/DeleteInbox">
<table border="1">
<tr>
<th>Select</th><th>SenderId</th><th>Date</th><th>Subject</th>
</tr>
<%
try{
while(rs.next())
...
<td><a href ="/ebooking/jsp/showmessage.jsp?msid=<%=rs.getInt("msgid")%>"><%=rs.getString("subject")%></a></td>
</tr>
<%}
}
