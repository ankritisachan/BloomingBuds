...
if(uid==null||hs.isNew()){
	...
	String strsql="select address,email,phoneno from kidregistration where userid=?";
...
try{
	if(rs.next()){%>
		...
		<form method="post" action="/bloomingBuds/Pedit">
			<table align="center" >
			<tr><th>Address:</th><td><input type="text" name="kaddress" value="<%=rs.getString("address")%>"></td></tr>
			<tr><th>Email:</th><td><input type="text" name="kemail" value="<%=rs.getString("email")%>"></td></tr>
			<tr><th>Phone:</th><td><input type="number" name="kphone" value="<%=rs.getLong("phoneno")%>"></td></tr>
...
<div style="margin-top: 10px;width: 1000px;height: 120px;float: left;margin-left: 0px">
