...
/**
 * Servlet implementation class DeleteSent
 */
@WebServlet("/DeleteSent")
public class DeleteSent extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String strupdate="update message set senderstatus=? where msgid=?";
		try{
